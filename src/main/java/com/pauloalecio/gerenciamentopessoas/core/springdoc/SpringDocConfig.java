package com.pauloalecio.gerenciamentopessoas.core.springdoc;

import static org.springframework.http.MediaType.APPLICATION_JSON_VALUE;

import com.pauloalecio.gerenciamentopessoas.api.exceptionhandler.Problem;
...
public class SpringDocConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Gerenciamento de Pessoas - Attus")
                        .version("v1")
                        .description("REST API desafio Attus")
                        .license(new License()
                                .name("Apache 2.0")
                        ...
                        .description("Attus")
                        .url("http://localhost:8081/gerenciamento-pessoa.com.br")
                ).tags(Arrays.asList(
